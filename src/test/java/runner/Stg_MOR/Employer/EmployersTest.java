package runner.Stg_MOR.Employer;
...
@CucumberOptions(
        features = "src/test/resources/features/Employer.Stg-MOR",
        glue = {"step_definitions/employers/Stg_MOR","step_definitions"},
        tags = "@case-3",
...
public class EmployersTest extends AbstractTestNGCucumberTests {
    ...
    public static void main(String[] args) {
        ...
        test.setName("Employers Stg-MOR Test Suite"); // tạo name cho test suite
